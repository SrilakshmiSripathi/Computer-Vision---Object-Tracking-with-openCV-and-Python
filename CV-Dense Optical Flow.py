...
# Read the capture and get the first frame- we are intrested only with gray channel first_image the video
...
while(cap.isOpened()):
    ...
    # Calculate dense optical flow by Farneback - Gunnar Farneback's algorithm.
    ...
    # Compute Magnitude and Angle (flow of earlier and flow of exsaturation)
